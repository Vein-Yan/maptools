    ...
    >
      ...
      <span slot="footer" class="dialog-footer">
        ...
        <el-button
          ...
          @click="handleBeginFilterBtnClick"
          >开始过滤</el-button
        >
      </span>
    </el-dialog>
    ...
    >
      ...
      <span slot="footer" class="dialog-footer">
        ...
        <el-button
          type="primary"
          v-loading.fullscreen.lock="fullscreenLoading"
          @click="handleSelectLonLatBtnClick"
          >保存</el-button
        >
      </span>
    </el-dialog>
